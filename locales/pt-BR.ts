...
export const ptBR: LocaleOverlay = {
  ...
  addUpcoming: {
    ...
    nameUtilities: 'Contas',
    schedule: 'Programação',
    oneTime: 'Uma vez',
    repeats: 'Repete',
    scheduleSegmentLabel: 'Tipo de programação',
    when: 'Quando?',
    whenTomorrow: 'Amanhã',
    whenNextWeek: 'Na próxima semana',
    whenInTwoWeeks: 'Em duas semanas',
    whenNextMonth: 'No próximo mês',
    ...
    onWhichDay: 'Em qual dia?',
    starting: 'Começando',
    startingThisWeek: 'Nesta semana',
    startingNextWeek: 'Na próxima semana',
    onThe: 'No dia',
    monthDayFirst: '1º',
    monthDayFifteenth: '15',
    monthDayThirtieth: '30',
    monthDayLast: 'Último dia',
    everyNDaysLabel: 'A cada N dias',
    everyNDaysDecrease: 'Menos dias',
    everyNDaysIncrease: 'Mais dias',
    save: 'Salvar',
  },
  money: {
    segmentSpent: 'Gasto',
    segmentUpcoming: 'Próximas',
    segmentHabits: 'Hábitos',
    segmentLabel: 'Visão de dinheiro',
    spentToday: 'Hoje',
    spentYesterday: 'Ontem',
    spentTodayEmpty: 'Nada ainda hoje. Adicione se você gastou, e aproveite se não gastou.',
    spentEditHint: 'Toque em uma linha para editar ou excluir.',
    recurringRowSuffix: 'recorrente',
    spentEmptyTitle: 'Todas as despesas em um só lugar',
    upcomingWindowSegmentLabel: 'Janela de próximas',
