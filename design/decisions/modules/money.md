...
- Upcoming Zero: no recurring expense exists at all, so the whole window and total card is dropped for a 96pt calculator and "Know what's coming before it lands". Reach: Persona new user.
...
- Habits Zero: 96pt dartboard, "Find the leak worth breaking". Reach: Persona new user.
...
## Open
- The Upcoming illustration is a placeholder. A calculator means arithmetic; this state is about a next date, so it wants a calendar or a clock. Seen on the 2026-09-05 walk, the clearest art-to-copy mismatch of the seven. ADR 0036.
- The Habits illustration is a placeholder. A dartboard means "hit your target"; "leak" is the product's own word and a dripping tap would name it. It pairs better with "Find the leak worth breaking" than expected, so this is the least urgent of the three swaps.
