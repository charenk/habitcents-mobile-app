...
- Kept Zero: no band, hook (a 96pt money sack since ADR 0036), one underlined link "Learn how skips and habits work" that opens [HowItWorksSheet](../components/HowItWorksSheet.md), and "Break your first habit" in the dock below (ADR 0038). No CTA in the stack and no explainer since 2026-09-07; no quote since ADR 0037. Same silhouette as Spent Zero. Kept Quiet: detection meter n of 4. Kept Live: band then Leaks found / Breaking now; check-in sub-states pending, skipped, slipped, milestone, backfill, weekly. Reach: returning user; milestone, backfill, weekly and Door 3 are canvas only.
