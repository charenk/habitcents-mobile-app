...
- Spent Zero: chips read words (ADR 0030), quick log, centered quote + icon-title-CTA hook. Reach: Persona new user, Door 1, close the sheet.
...
- Kept Zero: no band, quote + hook, Break another. Kept Quiet: detection meter n of 4. Kept Live: band then Leaks found / Breaking now; check-in sub-states pending, skipped, slipped, milestone, backfill, weekly. Reach: returning user; milestone, backfill, weekly and Door 3 are canvas only.
