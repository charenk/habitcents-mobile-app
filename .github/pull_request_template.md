<!-- Written for a designer reading in 30 seconds. Keep every section to 1-3 lines. -->

## Was / Now
<!-- Previous state on one line. New state on the next. -->

## Why (origin)
<!-- bet BET-NNN / QA report link / defect found by X / improvement because Y -->

## Improvement
<!-- What got better, plainly. -->
